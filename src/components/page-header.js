  ...
  header.innerHTML = `
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center gap-6 font-semibold">
        ...
        <a href="${basePath}src/page/nosotros.html" class="nav-link ${isNosotros ? 'text-[#C42100]' : 'text-white'} hover:text-[#C42100] transition" ${isNosotros ? 'data-active="true"' : ''}>Nosotros</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg">
      <nav class="flex flex-col p-4 space-y-4 font-semibold">
        ...
        <a href="${basePath}src/page/nosotros.html" class="nav-link-mobile ${isNosotros ? 'text-[#C42100]' : 'text-gray-900'} hover:text-[#C42100] transition py-2" ${isNosotros ? 'data-active="true"' : ''}>Nosotros</a>
